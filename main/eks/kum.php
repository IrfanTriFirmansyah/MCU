...
WHERE rekam_mcu.ket > '0' AND tb_paket.id_paket = '66'");
...
<body>
    ...
    <?php while ($sql = mysqli_fetch_array($van)) {
        $med = $sql['no_medrec'];
...
<div class="row ps-4" style=" width: 100%; height: 100vh;">
    <div class="col-6 pe-5">
        <div class="row d-flex align-items-center justify-content-center ms-3">
            ...
            <div class="col-12 d-flex align-items-center justify-content-center mt-3">
                <table style="width: 95%;">
                    ...
                    <tr style="font-size: 10px;">
                        <td class="border border-dark" style="padding: 10px; vertical-align: top; height: 100%; width: 40%;">
                            <textarea name="" id="autoResizeTextarea" style="background: none; border: none; resize: none; "rows="17"><?= $sql["kesimpulan"]; ?></textarea>
                        </td>
                        <td class="border border-dark" style="padding: 10px; vertical-align: top; height: 100%; width: 80%;">
