...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = mysqli_query($koneksi, "SELECT * FROM data_peserta WHERE nik = '$nik'");
                ...
                <tr style=" width: 100%;">
                  <td style="vertical-align: top; padding-top: 3px;">
                    <table style=" height: 70px; width: 100%; border-collapse: collapse;">
                      <tr>
                        <td style="width: 70%; height: 18px; border: 1px solid black;"><b style="font-size: 12px;"><?= $row['id_peserta'] ?></b></td>
              ...
              ?>
                ...
                <tr style=" width: 100%;">
                  <td style="vertical-align: top; padding-top: 3px;">
                    <table style=" height: 70px; width: 100%; border-collapse: collapse;">
                      <tr>
                        <td style="width: 70%; height: 18px; border: 1px solid black;"><b style="font-size: 15px;"><?= $row['id_peserta'] ?></b></td>
