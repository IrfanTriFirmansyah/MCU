                            ...
                            <table class="w-100">
                                <tr style="height: 50px;">
                                    ...
                                    <td>
                                        ...
                                        <textarea name="kesan_a" placeholder="Kesan" class="form-control w-75" style="height: 100px;" id=""><?php if( $row['kesan_a'] > 0){ echo $row['kesan_a']; } else{ ?>TELINGA KANAN : Fungsi pendengaran telinga kanan Normal
TELINGA KIRI : Fungsi pendengaran telinga kiri Normal <?php } ?></textarea>
                                    </td>
                                </tr>
                                <tr style="height: 50px;">
                                    <td style="width: 250px;">Saran</td>
                                    <td>
                                        <textarea name="saran_a" placeholder="saran" class="form-control w-75" style="height: 100px;" id=""><?php if( $row['saran_a'] > 0){ echo $row['saran_a']; } else{ ?>Hindari penggunaan headset terlalu sering, jika berada di area kerja dengan tingkat Bising lebih dari 85dB gunakan alat pelindung diri (ear plug / ear muff), 	Periksa audiometry 1 tahun lagi <?php } ?></textarea>
                                    </td>
                                </tr>
                                <tr style="height: 50px;">
