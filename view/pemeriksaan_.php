...
<main class="content">
    ...
    <div class="row" style="padding: 0;">
        ...
        <div class="col-9">
            <form action="" method="POST">
                <div class="input-group mb-3">
                    <input type="text" id="nik" name="nik" class="form-control" placeholder="Masukkan NIK/Nama" aria-label="Recipient's username" aria-describedby="button-addon2" required>
        ...
        if ($nik> 0) {
            ...
            WHERE nik LIKE '%" . $nik . "%' OR nama LIKE '%" . $nik . "%'
        ...
        ");
            ...
            if ($row1 > 1) {
                ...
                // $sql = mysqli_query($koneksi, "SELECT * FROM rekam_mcu WHERE nik = '$row1[nik]'");
                        ...
                        <div class="row w-100 justify-content-around gap-3 p-3">
                            ...
                            while ($rom = mysqli_fetch_array($mor)) {
                                ...
                                switch ($rom['tipe_paket']) {
                                    case 'tb_umum': ?>
                                        <form action="umum.php" method="POST" class="card p-2" style="width: 18rem; box-shadow: 0px 0px 10px black; text-decoration: none;">
                                            <input type="hidden" name="nik" value="<?php echo $row9['nik']; ?>">
                                    ...
                                    case 'tb_lab': ?>
                                        <form action="lab.php" method="POST" class="card p-2" style="width: 18rem; box-shadow: 0px 0px 10px black; text-decoration: none;">
                                            <input type="hidden" name="nik" value="<?php echo $row9['nik']; ?>">
                                    ...
                                    case 'tb_radiologi': ?>
                                        <form action="radiologi.php" method="POST" class="card p-2" style="width: 18rem; box-shadow: 0px 0px 10px black; text-decoration: none;">
                                            <input type="hidden" name="nik" value="<?php echo $row9['nik']; ?>">
                                    ...
                                    case 'tb_audiometri': ?>
                                        <form action="audiometri.php" method="POST" class="card p-2" style="width: 18rem; box-shadow: 0px 0px 10px black; text-decoration: none;">
                                            <input type="hidden" name="nik" value="<?php echo $row9['nik']; ?>">
                                    ...
                                    case 'tb_spirometri': ?>
                                        <form action="spirometri.php" method="POST" class="card p-2" style="width: 18rem; box-shadow: 0px 0px 10px black; text-decoration: none; ">
                                            <input type="hidden" name="nik" value="<?php echo $row9['nik']; ?>">
                                    ...
                                    case 'tb_ekg': ?>
                                        <form action="ekg.php" method="POST" class="card p-2" style="width: 18rem; box-shadow: 0px 0px 10px black; text-decoration: none; ">
                                            <input type="hidden" name="nik" value="<?php echo $row10['nik']; ?>">
                                    ...
                                    case 'tb_treadmil': ?>
                                        <form action="treadmil.php" method="POST" class="card p-2" style="width: 18rem; box-shadow: 0px 0px 10px black; text-decoration: none; ">
                                            <input type="hidden" name="nik" value="<?php echo $row11['nik']; ?>">
                            ...
                            <form action="resume.php" method="POST" class="card p-2" style="width: 18rem; box-shadow: 0px 0px 10px black; text-decoration: none; ">
                                <input type="hidden" name="nik" value="<?php echo $row9['nik']; ?>">
                                ...
                                <div class="card-body d-flex flex-column justify-content-center align-items-center">
                                    ...
                                    <?php
                                    if ($row11['kesimpulan'] > 0) {
                                    ?>
                                        <button type="submit" class="btn btn-success"><i data-feather="check-circle"></i> Sudah Diperiksa</button>
                                    <?php
                                    } elseif ($row11['kesimpulan']  < 1) {
                                    ?>
                                        <button type="submit" class="btn btn-danger"><i data-feather="x-circle"></i> Belum Diperiksa</button>
                                    <?php
                                    }
