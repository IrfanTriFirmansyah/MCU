...
<main class="content">
    <div class="row" style="padding: 0;">
        <div class="container-fluid p-0" style="display: flex; align-items: center; justify-content: space-between;">
            <h1 style="font-size: 40px; font-weight: bold;">Pendaftaran Karyawan</h1> <br>
        ...
        <form action="../proses/inp_lama.php" enctype="multipart/form-data" autocomplete="off" method="post">
            <div class="row text-dark" style="margin-left: 1px; margin-top: 20px; ">
                <div class="col-12 mt-4 border border-primary border-2 border-start-0 border-end-0 border-bottom-0 p-4 rounded-3 shadow-lg" style="background-color: white;">
                    <h2 style=" text-align: center;"><b>Form Pendaftaran Karyawan</b></h2>
                    <table class="w-100 mt-5 fs-4">
                        ...
                        <tr style="height: 50px;">
                            <td style="width: 250px;">NIK/NIP</td>
                            <td>
                                <input type="text" class="form-control w-75" name="nik" placeholder="Masukkan NIK/NIP"  id="" required>
                            </td>
                        </tr>
                        <tr style="height: 50px;">
                        ...
                        <tr style="height: 50px;">
                            ...
                            <td>
                                <input type="text" name="department" class="w-75 form-control" placeholder="department (Optional)" oninput="this.value = this.value.toUpperCase()">
                            </td>
                        </tr>
                        <tr style="height: 50px;">
                            <td style="width: 250px;">Lokasi Kerja</td>
                            <td>
                                <input type="text" name="lokasi" class="w-75 form-control" placeholder="lokasi kerja (Optional)" oninput="this.value = this.value.toUpperCase()">
                            </td>
                        </tr>
                        <tr style="height: 50px;">
                            <td style="width: 250px;">Nomor Telepon</td>
                            <td>
                                <input type="text" name="telp" class="w-75 form-control" placeholder="no. telepon WA (Optional)" value="0" id="" oninput="this.value = this.value.toUpperCase()">
                            </td>
                        </tr>
                        <tr style="height: 50px;">
                            <td style="width: 250px; vertical-align: top;">Alamat</td>
                            <td>
                                <!-- <input type="date" class="form-control w-25" name="tgl" id=""> -->
                                <textarea placeholder="Masukkan alamat (Optional)" name="alamat" id="" cols="30" class="form-control" rows="10">-</textarea>
                            </td>
                        </tr>
                    </table>
